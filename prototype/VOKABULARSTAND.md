...
| `crosswalk-bildungsabschnitte.json` | 0.2.0 | 6 | Zuordnung Modell A zu Modell B aus der Arbeitskarte Bildungsstruktur im Miro-B… | 2026-09-15 | teilweise_bestaetigt <br><small>A-zu-B bestaetigt, ISCED recherchiert_nicht_abgerufen</small> | Vier offene Punkte, darunter die Zuordnung von „Übergang Schule – Beruf“ |
...
| `reichweite-grob.json` | 0.1.0 | 4 | Variante 3 des Formulartests aus Workshop 4; Setzung der Arbeitsgruppe | 2026-09-15 | unbestaetigt | Variante 3 des Geografie-Tests, nicht beschlossen |
...
| `zielgruppen-entwurf.json` | 0.1.0 | 21 | Kein externes Vokabular. Zusammengetragen aus Begriffen, die in diesem Reposit… | 2026-09-16 | unbestaetigt | Entwurf für den Formulartest, keine Festlegung. Das Zielgruppenvokabular ist laut Sachstand offen |
| `zielgruppenrollen.json` | 0.2.0 | 5 | Festlegung der Arbeitsgruppe KKAB, erweitert | 2026-09-15 | unbestaetigt | Zwei Rollen deprecated; ob die Rollen gebraucht werden, ist Gegenstand des Formulartests |
...
**Die Zielgruppen-Entwurfsliste.** `zielgruppen-entwurf.json` ist kein
externes Vokabular. Die 21 Begriffe sind aus dem zusammengetragen, was in
diesem Repositorium bereits vorkommt: den Beispielen und Negativbeispielen
der Bildungsbereiche, den Handlungsfeldern und den drei Beispielprofilen.
Die Liste dient allein dem Formulartest — sie soll prüfbar machen, ob eine
Auswahl gegenüber Freitext trägt und ob die Rollen beim Ausfüllen gebraucht
werden. Sie beantwortet die Frage nicht.
